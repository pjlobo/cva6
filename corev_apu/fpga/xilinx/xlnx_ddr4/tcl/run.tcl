...
#generate_target {instantiation_template} [get_files /home/guillermo.izquierdo/project_1/project_1.srcs/sources_1/ip/ddr4_0/ddr4_0.xci]
generate_target {instantiation_template} [get_files ./$ipName.srcs/sources_1/ip/$ipName/$ipName.xci]

#generate_target all [get_files  /home/guillermo.izquierdo/project_1/project_1.srcs/sources_1/ip/ddr4_0/ddr4_0.xci]
generate_target all [get_files  ./$ipName.srcs/sources_1/ip/$ipName/$ipName.xci]
